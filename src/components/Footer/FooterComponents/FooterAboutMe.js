        ...
        return (
            <div>
                <p className="footer-aboutMe">MaxDron, oferujemy kompleksowe usługi z zakresu fotografii oraz filmowania
                    ...
                    szybko i w konkurencyjnych cenach po uzgodnieniu szczegółów z klientem. Angażując się w każdy
                    projekt
                    proponujemy ciekawe ujęcia i rozwiązania przy realizacji każdego projektu. Szybkość realizacji to
                    nasza mocna strona, istnieje możliwość otrzymania materiału nawet na drugi dzień po wykonaniu
                    zlecenia. Zdjęcia oraz nagrania przekazujemy w surowym formacie lub po odpowiedniej obróbce.
                </p>
